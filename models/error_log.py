...
class ErrorLogModel(db.Model):
    ...
    message_id = db.Column(UUID, db.ForeignKey('chats.id'), unique=False, nullable=True)
    message = db.relationship('MessageModel', back_populates='error_logs', lazy='dynamic')
